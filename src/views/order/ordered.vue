    ...
    <div class="top_box">
     ...
     <div class="table_box">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="accuName" label="客户姓名" width="100">
        </el-table-column>
        <el-table-column prop="serviceman" label="维修人员" width="100"> </el-table-column>

        <el-table-column prop="mainstate" label="维修状态" >
          <template slot-scope="scope">
            <el-tag
              :type="scope.row.mainstate === '已完成' ? 'success' :'primary' "
              disable-transitions
        ...
        <el-row slot-scope="scope">
          <!-- 编辑 -->
          <el-button type="text"   @click="editOrdered(scope.row)" :disabled="scope.row.paystate ==='已支付' ? true :false " style="margin-right:10px">完成支付</el-button>
          <!-- 删除 -->
            <!-- <el-popconfirm title="确定删除吗？" @confirm="deleteOrdered(scope.row)">
